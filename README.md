...
- [Beginner Guide](#beginner-guide)
	- [Use your own phpMyAdmin config](#use-your-own-piwik-config)
	- [HTTPS](#https)
...
- [Advanced User Guide](#advanced-user-guide)
	- [Extend osixia/piwik:2.16.2 image](#extend-osixiapiwik2162-image)
	- [Make your own phpMyAdmin image](#make-your-own-piwik-image)
	- [Tests](#tests)
